...
/* BEGIN this is just to appease makefile */
int server_test(void* args);
...
/* END this is just to appease makefile */
...
#ifdef WOLFSSL_SM2
    fprintf(stderr, "WOLFSSL_SM2 is enabled.\n");
#else
    fprintf(stderr, "WOLFSSL_SM2 is NOT enabled.\n");
#endif
