...
# mycerts: nonSM example for ZD16451 work by Jim:
#
...
echo -e "\n 1. Generate the CA key (secp256r1)"
openssl ecparam -genkey -name secp256r1 -outform pem -out ./demoCA/private/cakey.pem
...
echo -e "\n 5. Generate the client key (secp256r1)"
openssl ecparam -genkey -name secp256r1 -outform pem -out ./demoCA/private/clientkey.pem
...
echo -e "\n 9. Generate the server key (secp256r1)"
openssl ecparam -genkey -name secp256r1 -outform pem -out ./demoCA/private/serverkey.pem
