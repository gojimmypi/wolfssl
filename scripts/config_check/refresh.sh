...
WOLFSSL_OUTPUT="$WOLFSSL_FILE_ROOT/output$WOLFSSL_LOG_SUFFIX.txt"
WOLFSSL_OPTIONS="$WOLFSSL_FILE_ROOT/options$WOLFSSL_LOG_SUFFIX.h"
WOLFSSL_YES="$WOLFSSL_FILE_ROOT/Enabled-Features$WOLFSSL_LOG_SUFFIX.txt"
WOLFSSL_NO="$WOLFSSL_FILE_ROOT/Disabled-Features$WOLFSSL_LOG_SUFFIX.txt"
