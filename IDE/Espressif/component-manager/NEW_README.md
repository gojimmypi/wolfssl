This is the Expressif Component Version 5.6 of wolfSSL, test #13 (v1.0.14-dev)
...
* Refactor to use WOLFSSL_CTXâ€™s cipher suite list when possible
* Update internal padding of 0â€™s with DSA sign and additional tests with mp_to_unsigned_bin_len function
